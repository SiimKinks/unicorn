...
import static com.siimkinks.unicorn.AnimationDetails.DEFAULT;
...
public abstract class NavigationDetails {
     ...
     */
    public abstract AnimationDetails animation();
    ...
    public static abstract class Builder {
        ...
        /**
         * Animation details that define how this view should be animated when entering
         * or leaving it.
         *
         * @param details
         *         Animation details
         ...
         */
        @NonNull
        public abstract Builder animation(@NonNull AnimationDetails details);
         ...
         *         {@code true} when there should be only one instance if this
         *         view in stack at all times
         * @return Navigation details builder
         */
        @NonNull
         ...
         *
         * @param clearStack
         *         {@code true} when view stack should be cleared when
