...
public class ViewManagerTest {
  ...
  public void setup() {
    ...
    doNothing().when(viewManager).transitionBetween(any(NavigationDetails.class), any(NavigationDetails.class), anyBoolean());
  ...
  public void finishSecondTopView() {
    ...
    prevTopViewCallOrder.verify(prevTopView).setRootView(null);
  ...
  public void finishLastView() {
    ...
    verify(firstView).setRootView(null);
  ...
  public void navigateToViewWithClearStack() {
    ...
    verify(secondView).setRootView(null);
