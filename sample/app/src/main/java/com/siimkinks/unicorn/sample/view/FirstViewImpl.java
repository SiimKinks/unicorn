...
public final class FirstViewImpl extends ContentView<DIProvider, ViewPresenter> implements View {
    @BindView(R.id.content_text)
    TextView contentText;

    private ViewPresenter presenter;

    private FirstViewImpl() {
    }
